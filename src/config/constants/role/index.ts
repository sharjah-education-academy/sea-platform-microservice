...
export const DEFAULT_ROLES: {
  ...
  },
  {
    ...
    parentPermissionKeys: [
      ...
      CONSTANTS.Permission.PermissionKeys.ManageInitiativeProjectsRead,
      CONSTANTS.Permission.PermissionKeys.ManageInitiativeProgramsRead,
      CONSTANTS.Permission.PermissionKeys.ManageInitiativeActivitiesRead,
      CONSTANTS.Permission.PermissionKeys.ManageInitiativesOKRsRead,
      CONSTANTS.Permission.PermissionKeys.ManageInitiativesOKRsKeyResultRead,
      CONSTANTS.Permission.PermissionKeys.ManageInitiativeKPIsRead,
      CONSTANTS.Permission.PermissionKeys.ManageProjectsGeneralRead,
      ...
      CONSTANTS.Permission.PermissionKeys.ManageProjectRisksRead,
      CONSTANTS.Permission.PermissionKeys.ManageProjectIssuesRead,
      CONSTANTS.Permission.PermissionKeys.ManageProjectKPIsRead,
      CONSTANTS.Permission.PermissionKeys.ManageProgramsGeneralRead,
      ...
      CONSTANTS.Permission.PermissionKeys.ManageProgramRisksRead,
      CONSTANTS.Permission.PermissionKeys.ManageProgramIssuesRead,
      CONSTANTS.Permission.PermissionKeys.ManageProgramKPIsRead,
